...
conditions = {"$and": [{"skills": {"$exists": True, "$neq": []}},
                       {"experience": {"$exists": True, "$neq": []}},
                       {"primary.job": {"$exists": True, "$neq": None}}]}
